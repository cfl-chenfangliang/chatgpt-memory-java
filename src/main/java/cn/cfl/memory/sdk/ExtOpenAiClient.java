...
/**
 * {@link com.unfbx.chatgpt.OpenAiClient}
 *
 * @author chen.fangliang
 */
@Slf4j
public class ExtOpenAiClient {
     ...
     * @param builder
     */
    private ExtOpenAiClient(Builder builder) {
...
//    }
    ...
    public static final class Builder {
        ...
        public ExtOpenAiClient build() {
            return new ExtOpenAiClient(this);
        }
    }
}
